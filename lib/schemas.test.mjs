...
describe("CategorySchema", () => {
  it("accepts scope values for both film and person categories", () => {
    const base = { id: "cannes:palme-dor", festivalId: "cannes", name: "Palme d'Or", normalizedName: "palme-dor", isAward: true };
  ...
  it("requires isAward", () => {
    const base = { id: "cannes:palme-dor", festivalId: "cannes", name: "Palme d'Or", normalizedName: "palme-dor", scope: "film" };
